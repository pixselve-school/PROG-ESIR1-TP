...
public class CyclePrice extends Tarif {
  ...
  private CyclePrice(float pricePerPassenger, int basePrice, int addedPrice) {
   ...
   */
  public static CyclePrice createSingleton(float pricePerPassenger, int basePrice, int addedPrice) {
