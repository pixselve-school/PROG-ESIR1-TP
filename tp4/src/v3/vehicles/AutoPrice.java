...
public class AutoPrice extends Tarif {
  ...
  private AutoPrice(int pricePerPassenger, int basePrice, int addedPrice) {
   ...
   */
  public static AutoPrice createSingleton(int pricePerPassenger, int basePrice, int addedPrice) {
