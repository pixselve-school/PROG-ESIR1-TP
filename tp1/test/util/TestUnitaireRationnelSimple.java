...
public class TestUnitaireRationnelSimple
{
  ...
  Rationnel creerRationnel(int n)	  { return new RationnelSimple(n); }
  Rationnel creerRationnel(int n, int d ) { return new RationnelSimple(n, d); }
  Rationnel creerRationnel(Rationnel r )  { return new RationnelSimple(r); }
